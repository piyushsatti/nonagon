...
from nonagon_bot.core.infra.postgres.mappers import (
    player_to_orm,
    referee_to_orm,
    user_from_orm,
    user_to_orm,
)
from nonagon_bot.core.infra.postgres.models import UserModel
...
class UsersRepoPostgres:
    ...
    async def list_by_guild(self, guild_id: int) -> list[User]:
        ...
        async with get_session() as session:
            ...
            return [user_from_orm(m) for m in models]
